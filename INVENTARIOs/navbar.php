...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <img src="img/gif/ejemploGif3.gif" class="navbar-header" class='responsive' /></img><br />
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="<?php if (isset($active_productos)){echo $active_productos;}?>"><a href="stock.php"><i class='glyphicon glyphicon-barcode'></i> Socios</a></li>
		<li class="<?php if (isset($active_categoria)){echo $active_categoria;}?>"><a href="categorias.php"><i class='glyphicon glyphicon-tags'></i> Disciplinas</a></li>
        <li class="<?php if (isset($active_talle)){echo $active_talle;}?>"><a href="talles.php"><i class='glyphicon glyphicon-tags'></i> Categorías</a></li>
