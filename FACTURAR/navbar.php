...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <img src="../INVENTARIOs/img/gif/ejemploGif3.gif" class="navbar-header" class='responsive' /></img><br />
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php echo $active_inventario;?>"><a href='../INVENTARIOs/stock.php'><i  class='glyphicon glyphicon-barcode'></i> Inventario</a></li>
       </ul>
