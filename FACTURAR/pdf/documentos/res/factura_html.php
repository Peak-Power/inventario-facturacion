        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo " DEPORTES "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 50%; color: #34495e;font-size:12px;text-align:center">
				...
				$EMPRESA = "DEPORTES";
				$TEL = "(598)091 074 131";
				$EMAIL = "contacto@deportes.com.uy";
...
$insert=mysqli_query($con,"INSERT INTO facturas VALUES ('','$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura', '1','1')");
